...
const add_id = "gajjgkqrs8lotmsc"; // app_id
const app_secret = "QTlEOFhpcmw2ei9YalFEL2ZOandJdz09"; // app_secret
const key = "efa3bbecd0b242328e886648cd14d7a6" // key
function getWeather() {
...
$("#email").mouseover(function () {
    $("#link-text").html("给我来封 Email");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
$("#bilibili").mouseover(function () {
    $("#link-text").html("来 B 站看看我 ~");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
...
for (let day of days) {
    ...
    if (mon == d[0] && date == d[1]) {
        ...
        $("#change1").html("今天是中国国家纪念日，全站已切换为黑白模式 Today is China's National Day of Commemoration");
        window.addEventListener('load', function () {
            setTimeout(function () {
                iziToast.show({
                    timeout: 14000,
                    icon: "fa-solid fa-clock",
                    message: '严肃一点，今天是中国国家公纪日'
                });
            }, 3800);
        }, false);
    }
